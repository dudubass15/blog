      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="admin.php">Todas Postagens <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="nova_postagem.php">Nova Postagem</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin-top: -10px;">
          <h2 class="sub-header">Nova Postagem</h2>
